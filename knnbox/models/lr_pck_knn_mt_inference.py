...
from .less_retrieve_knn_mt import LessRetrieveSelector, LessRetrieveSelectorSimple


@register_model("lr_pck_knn_mt")
class LRPckKNNMT(AdaptiveKNNMT):
    r"""
    The  pck knn-mt model + Less retrieve selector
    """
    @staticmethod
    def add_args(parser):
        r"""
...
class PckKNNMTDecoder(TransformerDecoder):
    ...
    def forward(
        ...
        if self.args.knn_mode == "build_datastore":
        ...
        elif self.args.knn_mode == "train_metak":
            ...
            self.retriever.retrieve(self.datastore.vector_reduct(selected_features), return_list=["vals", "distances"])
...
"""
@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer")
def base_architecture(args):
    archs.base_architecture(args)

@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_iwslt_de_en")
def transformer_iwslt_de_en(args):
    archs.transformer_iwslt_de_en(args)

@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_wmt_en_de")
def transformer_wmt_en_de(args):
    archs.base_architecture(args)

# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_vaswani_wmt_en_de_big")
def transformer_vaswani_wmt_en_de_big(args):
    archs.transformer_vaswani_wmt_en_de_big(args)

@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    archs.transformer_vaswani_wmt_en_fr_big(args)

@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_wmt_en_de_big")
def transformer_wmt_en_de_big(args):
    archs.transformer_vaswani_wmt_en_de_big(args)

# default parameters used in tensor2tensor implementation
@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_wmt_en_de_big_t2t")
def transformer_wmt_en_de_big_t2t(args):
    archs.transformer_wmt_en_de_big_t2t(args)

@register_model_architecture("lr_pck_knn_mt", "lr_pck_knn_mt@transformer_wmt19_de_en")
